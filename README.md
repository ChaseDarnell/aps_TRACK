...
To build the final jar and optimize the apsTRACK application for production, run:
...
Then navigate to [http://localhost:5432](http://localhost:5432) in your browser.
